...
Below is a short overview of the package functionality using a fake dataset.
...
The method **iso_compute_stats** parses the isoform raw count matrix and returns a data frame with the following structure:
...
Alternatively, **plot_marker_score** can also plot individual plots for each cluster analyzed
